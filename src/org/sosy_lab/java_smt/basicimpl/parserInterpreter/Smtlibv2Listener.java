...
public interface Smtlibv2Listener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by the {@code spec_constant_fp}
	 * labeled alternative in {@link Smtlibv2Parser#spec_constant}.
	 * @param ctx the parse tree
	 */
	void enterSpec_constant_fp(Smtlibv2Parser.Spec_constant_fpContext ctx);
	/**
	 * Exit a parse tree produced by the {@code spec_constant_fp}
	 * labeled alternative in {@link Smtlibv2Parser#spec_constant}.
	 * @param ctx the parse tree
	 */
	void exitSpec_constant_fp(Smtlibv2Parser.Spec_constant_fpContext ctx);
	/**
	 * Enter a parse tree produced by the {@code spec_constant_regex}
	 * labeled alternative in {@link Smtlibv2Parser#spec_constant}.
	 * @param ctx the parse tree
	 */
	void enterSpec_constant_regex(Smtlibv2Parser.Spec_constant_regexContext ctx);
	/**
	 * Exit a parse tree produced by the {@code spec_constant_regex}
	 * labeled alternative in {@link Smtlibv2Parser#spec_constant}.
	 * @param ctx the parse tree
	 */
	...
	/**
	 * Enter a parse tree produced by the {@code term_fp_cast}
	 * labeled alternative in {@link Smtlibv2Parser#term}.
	 * @param ctx the parse tree
	 */
	void enterTerm_fp_cast(Smtlibv2Parser.Term_fp_castContext ctx);
	/**
	 * Exit a parse tree produced by the {@code term_fp_cast}
	 * labeled alternative in {@link Smtlibv2Parser#term}.
	 * @param ctx the parse tree
	 */
	void exitTerm_fp_cast(Smtlibv2Parser.Term_fp_castContext ctx);
	/**
	 * Enter a parse tree produced by the {@code term_special_regex}
	 * labeled alternative in {@link Smtlibv2Parser#term}.
	 * @param ctx the parse tree
	 */
	void enterTerm_special_regex(Smtlibv2Parser.Term_special_regexContext ctx);
	/**
	 * Exit a parse tree produced by the {@code term_special_regex}
	 * labeled alternative in {@link Smtlibv2Parser#term}.
	 * @param ctx the parse tree
	 */
