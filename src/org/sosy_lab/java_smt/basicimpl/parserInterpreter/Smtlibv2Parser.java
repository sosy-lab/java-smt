...
public class Smtlibv2Parser extends Parser {
  ...
  public static final int Comment = 1,
      ...
      CMD_DeclareConst = 32,
      CMD_DeclareDatatype = 33,
      CMD_DeclareDatatypes = 34,
      CMD_DeclareFun = 35,
      CMD_DeclareSort = 36,
      CMD_DefineFun = 37,
      CMD_DefineFunRec = 38,
      CMD_DefineFunsRec = 39,
      CMD_DefineSort = 40,
      CMD_Echo = 41,
      CMD_Exit = 42,
      CMD_GetAssertions = 43,
      CMD_GetAssignment = 44,
      CMD_GetInfo = 45,
      CMD_GetModel = 46,
      CMD_GetOption = 47,
      CMD_GetProof = 48,
      CMD_GetUnsatAssumptions = 49,
      CMD_GetUnsatCore = 50,
      CMD_GetValue = 51,
      CMD_Pop = 52,
      CMD_Push = 53,
      CMD_Reset = 54,
      CMD_ResetAssertions = 55,
      CMD_SetInfo = 56,
      CMD_SetLogic = 57,
      CMD_SetOption = 58,
      GRW_Exclamation = 59,
      ...
      Colon = 77,
      PK_AllStatistics = 78,
      PK_AssertionStackLevels = 79,
      PK_Authors = 80,
      PK_Category = 81,
      PK_Chainable = 82,
      PK_Definition = 83,
      PK_DiagnosticOutputChannel = 84,
      PK_ErrorBehaviour = 85,
      PK_Extension = 86,
      PK_Funs = 87,
      PK_FunsDescription = 88,
      PK_GlobalDeclarations = 89,
      PK_InteractiveMode = 90,
      PK_Language = 91,
      PK_LeftAssoc = 92,
      PK_License = 93,
      PK_Named = 94,
      ...
      PK_Pattern = 97,
      PK_PrintSuccess = 98,
      PK_ProduceAssertions = 99,
      PK_ProduceAssignments = 100,
      PK_ProduceModels = 101,
      PK_ProduceProofs = 102,
      PK_ProduceUnsatAssumptions = 103,
      PK_ProduceUnsatCores = 104,
      PK_RandomSeed = 105,
      PK_ReasonUnknown = 106,
      PK_RegularOutputChannel = 107,
      PK_ReproducibleResourceLimit = 108,
      PK_RightAssoc = 109,
      PK_SmtLibVersion = 110,
      PK_Sorts = 111,
      PK_SortsDescription = 112,
      PK_Source = 113,
      PK_Status = 114,
      PK_Theories = 115,
      PK_Values = 116,
  ...
  public static final int RULE_start = 0,
      ...
      RULE_string = 10,
      RULE_to_fp_expr = 11,
      RULE_special_regex_operations = 12,
      RULE_keyword = 13,
      RULE_symbol = 14,
      ...
      RULE_cmd_declareSort = 51,
      RULE_cmd_defineFun = 52,
      RULE_cmd_defineFunRec = 53,
      RULE_cmd_defineFunsRec = 54,
      RULE_cmd_defineSort = 55,
      RULE_cmd_echo = 56,
      RULE_cmd_exit = 57,
      RULE_cmd_getAssertions = 58,
      RULE_cmd_getAssignment = 59,
      RULE_cmd_getInfo = 60,
      RULE_cmd_getModel = 61,
      RULE_cmd_getOption = 62,
      RULE_cmd_getProof = 63,
      RULE_cmd_getUnsatAssumptions = 64,
      RULE_cmd_getUnsatCore = 65,
      RULE_cmd_getValue = 66,
      RULE_cmd_pop = 67,
      RULE_cmd_push = 68,
      RULE_cmd_reset = 69,
      RULE_cmd_resetAssertions = 70,
      RULE_cmd_setInfo = 71,
      RULE_cmd_setLogic = 72,
      RULE_cmd_setOption = 73,
      RULE_command = 74,
      RULE_b_value = 75,
      RULE_option = 76,
      RULE_info_flag = 77,
      RULE_error_behaviour = 78,
      RULE_reason_unknown = 79,
      RULE_model_response = 80,
      RULE_info_response = 81,
      RULE_valuation_pair = 82,
      RULE_t_valuation_pair = 83,
      RULE_check_sat_response = 84,
      RULE_echo_response = 85,
      RULE_get_assertions_response = 86,
      RULE_get_assignment_response = 87,
      RULE_get_info_response = 88,
      RULE_get_model_response = 89,
      RULE_get_option_response = 90,
      RULE_get_proof_response = 91,
      RULE_get_unsat_assump_response = 92,
      RULE_get_unsat_core_response = 93,
      RULE_get_value_response = 94,
      RULE_specific_success_response = 95,
  ...
  public static class Special_regex_operationsContext extends ParserRuleContext {
    public TerminalNode RE_LOOP_EXPR() {
      return getToken(Smtlibv2Parser.RE_LOOP_EXPR, 0);
    }
    ...
    public TerminalNode RE_TIMES_EXPR() {
      return getToken(Smtlibv2Parser.RE_TIMES_EXPR, 0);
    }
    ...
    @Override
    public int getRuleIndex() {
      return RULE_special_regex_operations;
    }

    @Override
    public void enterRule(ParseTreeListener listener) {
      if (listener instanceof Smtlibv2Listener)
        ((Smtlibv2Listener) listener).enterSpecial_regex_operations(this);
    }

    @Override
    public void exitRule(ParseTreeListener listener) {
      if (listener instanceof Smtlibv2Listener)
        ((Smtlibv2Listener) listener).exitSpecial_regex_operations(this);
    }

    @Override
    public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof Smtlibv2Visitor)
        return ((Smtlibv2Visitor<? extends T>) visitor).visitSpecial_regex_operations(this);
      else return visitor.visitChildren(this);
    }
  }

  public final Special_regex_operationsContext special_regex_operations()
      throws RecognitionException {
    Special_regex_operationsContext _localctx =
        new Special_regex_operationsContext(_ctx, getState());
  ...
  public static class Spec_constant_regexContext extends Spec_constantContext {
    public TerminalNode REGEXVALUES() {
      return getToken(Smtlibv2Parser.REGEXVALUES, 0);
    }

    public Spec_constant_regexContext(Spec_constantContext ctx) {
      copyFrom(ctx);
    }
    ...
    public void enterRule(ParseTreeListener listener) {
      if (listener instanceof Smtlibv2Listener)
        ((Smtlibv2Listener) listener).enterSpec_constant_regex(this);
    }

    @Override
    public void exitRule(ParseTreeListener listener) {
      if (listener instanceof Smtlibv2Listener)
        ((Smtlibv2Listener) listener).exitSpec_constant_regex(this);
    }

    @Override
    public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof Smtlibv2Visitor)
        return ((Smtlibv2Visitor<? extends T>) visitor).visitSpec_constant_regex(this);
      else return visitor.visitChildren(this);
    }
  }
      ...
      switch (_input.LA(1)) {
        ...
        case ParOpen:
          ...
          enterOuterAlt(_localctx, 4);
          {
            ...
            _errHandler.sync(this);
            _la = _input.LA(1);
            while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 536863588L) != 0)
                || ((((_la - 73)) & ~0x3f) == 0 && ((1L << (_la - 73)) & 211106232532991L) != 0)) {
              {
                {
                  setState(271);
                  s_expr();
        ...
        case ParOpen:
          ...
          enterOuterAlt(_localctx, 2);
          {
            ...
            do {
              ...
              _errHandler.sync(this);
              _la = _input.LA(1);
            } while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 536862784L) != 0)
                || _la == Numeral
                || _la == UndefinedSymbol);
            setState(293);
            match(ParClose);
        ...
        case 3:
          ...
          enterOuterAlt(_localctx, 3);
          {
            ...
            do {
              ...
              _errHandler.sync(this);
              _la = _input.LA(1);
            } while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 536862916L) != 0)
                || _la == UndefinedSymbol);
            setState(324);
            match(ParClose);
          }
  ...
  public static class Term_special_regexContext extends TermContext {
    ...
    public Term_special_regexContext(TermContext ctx) {
      copyFrom(ctx);
    }
    ...
    public void enterRule(ParseTreeListener listener) {
      if (listener instanceof Smtlibv2Listener)
        ((Smtlibv2Listener) listener).enterTerm_special_regex(this);
    }

    @Override
    public void exitRule(ParseTreeListener listener) {
      if (listener instanceof Smtlibv2Listener)
        ((Smtlibv2Listener) listener).exitTerm_special_regex(this);
    }

    @Override
    public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof Smtlibv2Visitor)
        return ((Smtlibv2Visitor<? extends T>) visitor).visitTerm_special_regex(this);
      else return visitor.visitChildren(this);
    }
  }
        ...
        case 5:
          ...
          enterOuterAlt(_localctx, 5);
          {
            ...
            do {
              ...
              _errHandler.sync(this);
              _la = _input.LA(1);
            } while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 536870756L) != 0)
                || ((((_la - 73)) & ~0x3f) == 0 && ((1L << (_la - 73)) & 140737488355343L) != 0));
            setState(375);
            match(ParClose);
          }
          break;
  ...
  public final Cmd_checkSatAssumingContext cmd_checkSatAssuming() throws RecognitionException {
    ...
    try {
      enterOuterAlt(_localctx, 1);
      {
        ...
        _errHandler.sync(this);
        _la = _input.LA(1);
        while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 536862788L) != 0)
            || _la == UndefinedSymbol) {
          {
            {
              setState(682);
