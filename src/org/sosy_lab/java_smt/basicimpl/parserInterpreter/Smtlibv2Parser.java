...
public class Smtlibv2Parser extends Parser {
	...
	public static final int
		...
		FLOATING_POINT_SORT=7, FLOATING_POINT_NUMBER=8, TO_FP_EXPR=9, PS_Not=10, 
		PS_Bool=11, PS_ContinuedExecution=12, PS_Error=13, PS_False=14, PS_ImmediateExit=15, 
		PS_Incomplete=16, PS_Logic=17, PS_Memout=18, PS_Sat=19, PS_Success=20, 
		PS_Theory=21, PS_True=22, PS_Unknown=23, PS_Unsupported=24, PS_Unsat=25, 
		CMD_Assert=26, CMD_CheckSat=27, CMD_CheckSatAssuming=28, CMD_DeclareConst=29, 
		CMD_DeclareDatatype=30, CMD_DeclareDatatypes=31, CMD_DeclareFun=32, CMD_DeclareSort=33, 
		CMD_DefineFun=34, CMD_DefineFunRec=35, CMD_DefineFunsRec=36, CMD_DefineSort=37, 
		CMD_Echo=38, CMD_Exit=39, CMD_GetAssertions=40, CMD_GetAssignment=41, 
		CMD_GetInfo=42, CMD_GetModel=43, CMD_GetOption=44, CMD_GetProof=45, CMD_GetUnsatAssumptions=46, 
		CMD_GetUnsatCore=47, CMD_GetValue=48, CMD_Pop=49, CMD_Push=50, CMD_Reset=51, 
		CMD_ResetAssertions=52, CMD_SetInfo=53, CMD_SetLogic=54, CMD_SetOption=55, 
		GRW_Exclamation=56, GRW_Underscore=57, GRW_As=58, GRW_Binary=59, GRW_Decimal=60, 
		GRW_Exists=61, GRW_Hexadecimal=62, GRW_Forall=63, GRW_Let=64, GRW_Match=65, 
		GRW_Numeral=66, GRW_Par=67, GRW_String=68, GRW_FloatingPoint=69, Numeral=70, 
		Binary=71, HexDecimal=72, Decimal=73, Colon=74, PK_AllStatistics=75, PK_AssertionStackLevels=76, 
		PK_Authors=77, PK_Category=78, PK_Chainable=79, PK_Definition=80, PK_DiagnosticOutputChannel=81, 
		PK_ErrorBehaviour=82, PK_Extension=83, PK_Funs=84, PK_FunsDescription=85, 
		PK_GlobalDeclarations=86, PK_InteractiveMode=87, PK_Language=88, PK_LeftAssoc=89, 
		PK_License=90, PK_Named=91, PK_Name=92, PK_Notes=93, PK_Pattern=94, PK_PrintSuccess=95, 
		PK_ProduceAssertions=96, PK_ProduceAssignments=97, PK_ProduceModels=98, 
		PK_ProduceProofs=99, PK_ProduceUnsatAssumptions=100, PK_ProduceUnsatCores=101, 
		PK_RandomSeed=102, PK_ReasonUnknown=103, PK_RegularOutputChannel=104, 
		PK_ReproducibleResourceLimit=105, PK_RightAssoc=106, PK_SmtLibVersion=107, 
		PK_Sorts=108, PK_SortsDescription=109, PK_Source=110, PK_Status=111, PK_Theories=112, 
		PK_Values=113, PK_Verbosity=114, PK_Version=115, RS_Model=116, UndefinedSymbol=117, 
		WS=118;
	public static final int
		...
		RULE_keyword = 12, RULE_symbol = 13, RULE_spec_constant = 14, RULE_s_expr = 15, 
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"to_fp_expr", "keyword", "symbol", "spec_constant", "s_expr", "index", 
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"'string'", "'_ FloatingPoint'", null, null, null, null, "':'", "':all-statistics'", 
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"FLOATING_POINT_SORT", "FLOATING_POINT_NUMBER", "TO_FP_EXPR", "PS_Not", 
			"PS_Bool", "PS_ContinuedExecution", "PS_Error", "PS_False", "PS_ImmediateExit", 
	...
	public final S_exprContext s_expr() throws RecognitionException {
		...
		try {
			...
			case ParOpen:
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 67108196L) != 0) || ((((_la - 70)) & ~0x3f) == 0 && ((1L << (_la - 70)) & 211106232532991L) != 0)) {
					{
					{
					setState(260);
					s_expr();
		...
		try {
			...
			case ParOpen:
				...
				do {
					...
					_errHandler.sync(this);
					_la = _input.LA(1);
				} while ( (((_la) & ~0x3f) == 0 && ((1L << _la) & 67107904L) != 0) || _la==Numeral || _la==UndefinedSymbol );
				setState(282);
				match(ParClose);
				}
				break;
		...
		try {
			...
			case 4:
				...
				do {
					...
					_errHandler.sync(this);
					_la = _input.LA(1);
				} while ( (((_la) & ~0x3f) == 0 && ((1L << _la) & 67108708L) != 0) || ((((_la - 70)) & ~0x3f) == 0 && ((1L << (_la - 70)) & 140737488355343L) != 0) );
				setState(363);
				match(ParClose);
				}
				break;
