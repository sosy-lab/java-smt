...
// Generated from
// /home/davidg/IdeaProjects/java-smt/src/
// org/sosy_lab/java_smt/basicimpl/parserInterpreter/Smtlibv2.g4 by ANTLR 4.13.2
...
public class Smtlibv2Parser extends Parser {
  ...
  public static final int Comment = 1,
      ...
      FloatingPointShortVariant = 71,
      NumeralFloatingPoint = 72,
      BinaryFloatingPoint = 73,
      FloatingPointPlusOrMinusInfinity = 74,
      FloatingPointPlusOrMinusZero = 75,
      NotANumberFloatingPoint = 76,
      FloatingPoint = 77,
      Colon = 78,
      PK_AllStatistics = 79,
      PK_AssertionStackLevels = 80,
      PK_Authors = 81,
      PK_Category = 82,
      PK_Chainable = 83,
      PK_Definition = 84,
      PK_DiagnosticOutputChannel = 85,
      PK_ErrorBehaviour = 86,
      PK_Extension = 87,
      PK_Funs = 88,
      PK_FunsDescription = 89,
      PK_GlobalDeclarations = 90,
      PK_InteractiveMode = 91,
      PK_Language = 92,
      PK_LeftAssoc = 93,
      PK_License = 94,
      PK_Named = 95,
      ...
      PK_Pattern = 98,
      PK_PrintSuccess = 99,
      PK_ProduceAssertions = 100,
      PK_ProduceAssignments = 101,
      PK_ProduceModels = 102,
      PK_ProduceProofs = 103,
      PK_ProduceUnsatAssumptions = 104,
      PK_ProduceUnsatCores = 105,
      PK_RandomSeed = 106,
      PK_ReasonUnknown = 107,
      PK_RegularOutputChannel = 108,
      PK_ReproducibleResourceLimit = 109,
      PK_RightAssoc = 110,
      PK_SmtLibVersion = 111,
      PK_Sorts = 112,
      PK_SortsDescription = 113,
      PK_Source = 114,
      PK_Status = 115,
      PK_Theories = 116,
      PK_Values = 117,
        ...
        case ParOpen:
          ...
          enterOuterAlt(_localctx, 4);
          {
            ...
            while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 8388580L) != 0)
                || ((((_la - 66)) & ~0x3f) == 0
                    && ((1L << (_la - 66)) & 54043195528443919L) != 0)) {
              {
                {
                  setState(251);
                  s_expr();
          ...
          enterOuterAlt(_localctx, 3);
          {
            ...
            do {
              ...
              _la = _input.LA(1);
                ...
                || ((((_la - 66)) & ~0x3f) == 0 && ((1L << (_la - 66)) & 36028797018966031L) != 0));
            setState(352);
            match(ParClose);
          }
          break;
