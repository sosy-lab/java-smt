...
@SuppressWarnings({"all", "UnnecessaryParentheses",
		"warnings", "unchecked", "unused", "cast", "CheckReturnValue", "this-escape"})
public class smtlibv2Parser extends Parser {
	...
	public static final int
		...
		FloatingPointNumeral=71, FloatingPointShortVariant=72, NumeralFloatingPoint=73, 
		BinaryFloatingPoint=74, HexadecimalFloatingPoint=75, FloatingPointPlusOrMinusInfinity=76, 
		FloatingPointPlusOrMinusZero=77, NotANumberFloatingPoint=78, FloatingPoint=79, 
		Colon=80, PK_AllStatistics=81, PK_AssertionStackLevels=82, PK_Authors=83, 
		PK_Category=84, PK_Chainable=85, PK_Definition=86, PK_DiagnosticOutputChannel=87, 
		PK_ErrorBehaviour=88, PK_Extension=89, PK_Funs=90, PK_FunsDescription=91, 
		PK_GlobalDeclarations=92, PK_InteractiveMode=93, PK_Language=94, PK_LeftAssoc=95, 
		PK_License=96, PK_Named=97, PK_Name=98, PK_Notes=99, PK_Pattern=100, PK_PrintSuccess=101, 
		PK_ProduceAssertions=102, PK_ProduceAssignments=103, PK_ProduceModels=104, 
		PK_ProduceProofs=105, PK_ProduceUnsatAssumptions=106, PK_ProduceUnsatCores=107, 
		PK_RandomSeed=108, PK_ReasonUnknown=109, PK_RegularOutputChannel=110, 
		PK_ReproducibleResourceLimit=111, PK_RightAssoc=112, PK_SmtLibVersion=113, 
		PK_Sorts=114, PK_SortsDescription=115, PK_Source=116, PK_Status=117, PK_Theories=118, 
		PK_Values=119, PK_Verbosity=120, PK_Version=121, RS_Model=122, UndefinedSymbol=123, 
		WS=124;
	public static final int
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			null, null, null, null, null, null, null, null, "':'", "':all-statistics'", 
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"Decimal", "NumeralExponentsWithSpace", "FloatingPointNumeral", "FloatingPointShortVariant", 
			"NumeralFloatingPoint", "BinaryFloatingPoint", "HexadecimalFloatingPoint", 
			"FloatingPointPlusOrMinusInfinity", "FloatingPointPlusOrMinusZero", "NotANumberFloatingPoint", 
			"FloatingPoint", "Colon", "PK_AllStatistics", "PK_AssertionStackLevels", 
	...
	public final GeneralReservedWordContext generalReservedWord() throws RecognitionException {
		...
		try {
			...
			setState(206);
			_la = _input.LA(1);
			if ( !((((_la) & ~0x3f) == 0 && ((1L << _la) & -9007199254740992L) != 0) || ((((_la - 64)) & ~0x3f) == 0 && ((1L << (_la - 64)) & 288230376151711747L) != 0)) ) {
	...
	public final PredefKeywordContext predefKeyword() throws RecognitionException {
		...
		try {
			...
			setState(216);
			_la = _input.LA(1);
			if ( !(((((_la - 81)) & ~0x3f) == 0 && ((1L << (_la - 81)) & 2199023255551L) != 0)) ) {
			_errHandler.recoverInline(this);
			}
			else {
				if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
	...
	public final S_exprContext s_expr() throws RecognitionException {
		...
		try {
			...
			case ParOpen:
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 8388580L) != 0) || ((((_la - 66)) & ~0x3f) == 0 && ((1L << (_la - 66)) & 216172782113775631L) != 0)) {
					{
					{
					setState(251);
					s_expr();
		...
		try {
			...
			case 3:
				...
				do {
					...
					_errHandler.sync(this);
					_la = _input.LA(1);
				} while ( (((_la) & ~0x3f) == 0 && ((1L << _la) & 8388580L) != 0) || ((((_la - 66)) & ~0x3f) == 0 && ((1L << (_la - 66)) & 144115188075864079L) != 0) );
				setState(352);
				match(ParClose);
				}
				break;
			...
			case 8:
				...
				do {
					...
					_errHandler.sync(this);
					_la = _input.LA(1);
				} while ( ((((_la - 80)) & ~0x3f) == 0 && ((1L << (_la - 80)) & 4398046511103L) != 0) );
				setState(410);
				match(ParClose);
				}
				break;
