...
public interface Smtlibv2Visitor<T> extends ParseTreeVisitor<T> {
  ...
  /**
   * Visit a parse tree produced by {@link Smtlibv2Parser#to_fp_expr}.
   *
   * @param ctx the parse tree
   * @return the visitor result
   */
  T visitTo_fp_expr(Smtlibv2Parser.To_fp_exprContext ctx);

  /**
   * Visit a parse tree produced by {@link Smtlibv2Parser#special_regex_operations}.
   *
   * @param ctx the parse tree
   * @return the visitor result
   */
  T visitSpecial_regex_operations(Smtlibv2Parser.Special_regex_operationsContext ctx);
  ...
  /**
   * Visit a parse tree produced by the {@code spec_constant_fp} labeled alternative in {@link
   * Smtlibv2Parser#spec_constant}.
   *
   * @param ctx the parse tree
   * @return the visitor result
   */
  T visitSpec_constant_fp(Smtlibv2Parser.Spec_constant_fpContext ctx);

  /**
   * Visit a parse tree produced by the {@code spec_constant_regex} labeled alternative in {@link
   * Smtlibv2Parser#spec_constant}.
   *
   * @param ctx the parse tree
   * @return the visitor result
   */
  T visitSpec_constant_regex(Smtlibv2Parser.Spec_constant_regexContext ctx);
  ...
  /**
   * Visit a parse tree produced by the {@code sortfp} labeled alternative in {@link
   * Smtlibv2Parser#sort}.
   *
   * @param ctx the parse tree
   * @return the visitor result
   */
  T visitSortfp(Smtlibv2Parser.SortfpContext ctx);
  ...
  /**
   * Visit a parse tree produced by the {@code term_fp_cast} labeled alternative in {@link
   * Smtlibv2Parser#term}.
   *
   * @param ctx the parse tree
   * @return the visitor result
   */
  T visitTerm_fp_cast(Smtlibv2Parser.Term_fp_castContext ctx);

  /**
   * Visit a parse tree produced by the {@code term_special_regex} labeled alternative in {@link
   * Smtlibv2Parser#term}.
   *
   * @param ctx the parse tree
   * @return the visitor result
   */
  T visitTerm_special_regex(Smtlibv2Parser.Term_special_regexContext ctx);
