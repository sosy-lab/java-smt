 ...
 *
 *  - Z3_OP_PR_TH_LEMMA: Generic proof for theory lemmas. The theory lemma function comes with one
 ...
 *    arithmetic are:
 *
 *      - farkas - followed by rational coefficients. Multiply the coefficients to the inequalities in
 ...
 *
 * As other solvers do not work in this way, an extension specifically for Z3 is provided.
 */
