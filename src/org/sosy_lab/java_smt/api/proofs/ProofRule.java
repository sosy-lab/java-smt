...
public interface ProofRule {
  ...
  /**
   * Returns an Optional of the extension type passed as argument. Example: For a Z3 {@link
   * ProofRule} there might be parameters present, see {@link Z3ProofRuleParameter}, the interface
   * {@link Z3ProofRuleExtension} has a method for retrieving these parameters.
   *
