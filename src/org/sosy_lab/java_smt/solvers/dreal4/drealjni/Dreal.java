...
public final class Dreal {
  ...
  public static SwigTypePStdOstream insertOperator(SwigTypePStdOstream os, Variable var) {
    return new SwigTypePStdOstream(
        DrealJNI.insertOperatorSWIG0(
            SwigTypePStdOstream.getCPtr(os), Variable.getCPtr(var), var),
        false);
  }

  public static SwigTypePStdOstream insertOperator(
      SwigTypePStdOstream os, Variable.Type type) {
    return new SwigTypePStdOstream(
        DrealJNI.insertOperatorSWIG1(SwigTypePStdOstream.getCPtr(os), type.swigValue()),
        false);
  }
  ...
  public static SwigTypePStdOstream insertOperator(
      SwigTypePStdOstream arg0, Variables vars) {
    return new SwigTypePStdOstream(
  ...
  public static Variables add(Variables vars1, Variables vars2) {
    return new Variables(
        DrealJNI.addSWIG0(Variables.getCPtr(vars1), vars1, Variables.getCPtr(vars2), vars2),
        true);
  }
  ...
  public static Variables substract(Variables vars, Variable var) {
    return new Variables(
        DrealJNI.substractSWIG1(Variables.getCPtr(vars), vars, Variable.getCPtr(var), var),
        true);
  }

  public static SwigTypePStdOstream insertOperator(
      SwigTypePStdOstream os, Environment env) {
    return new SwigTypePStdOstream(
  ...
  public static Expression AddEqual(Expression lhs, Expression rhs) {
    return new Expression(
        DrealJNI.addEqualSWIG2(Expression.getCPtr(lhs), lhs, Expression.getCPtr(rhs), rhs),
        false);
  }

  public static Expression substract(Expression lhs, Expression rhs) {
    return new Expression(
        DrealJNI.substractSWIG2(Expression.getCPtr(lhs), lhs, Expression.getCPtr(rhs), rhs),
        true);
  }
  ...
  public static Expression multiply(Expression lhs, Expression rhs) {
    return new Expression(
        DrealJNI.multiplySWIG0(Expression.getCPtr(lhs), lhs, Expression.getCPtr(rhs), rhs),
        true);
  }
  ...
  public static Expression realConstant(double lb, double ub, boolean use_lb_as_representative) {
    return new Expression(DrealJNI.realConstant(lb, ub, use_lb_as_representative), true);
  }
  ...
  public static Expression ifThenElse(Formula f_cond, Expression e_then, Expression e_else) {
    return new Expression(
        DrealJNI.ifThenElse(
  ...
  public static SwigTypePStdOstream insertOperator(SwigTypePStdOstream os, Expression e) {
    return new SwigTypePStdOstream(
        DrealJNI.insertOperatorSWIG4(
            SwigTypePStdOstream.getCPtr(os), Expression.getCPtr(e), e),
        false);
  }
  ...
  public static Formula and(Formula f1, Formula f2) {
    return new Formula(
        DrealJNI.andSWIG0(Formula.getCPtr(f1), f1, Formula.getCPtr(f2), f2), true);
  }
  ...
  public static Formula and(Variable v1, Variable v2) {
    return new Formula(
        DrealJNI.andSWIG8(Variable.getCPtr(v1), v1, Variable.getCPtr(v2), v2), true);
  }
  ...
  public static Formula or(Variable v1, Variable v2) {
    return new Formula(
        DrealJNI.orSWIG8(Variable.getCPtr(v1), v1, Variable.getCPtr(v2), v2), true);
  }
  ...
  public static Formula equal(Formula f1, Formula f2) {
    return new Formula(
        DrealJNI.equalSWIG3(Formula.getCPtr(f1), f1, Formula.getCPtr(f2), f2), true);
  }
  ...
  public static Formula notEqual(Variable v, Formula f) {
    return new Formula(
        DrealJNI.notEqualSWIG3(Variable.getCPtr(v), v, Formula.getCPtr(f), f), true);
  }

  public static Formula notEqual(Formula f, Variable v) {
    return new Formula(
        DrealJNI.notEqualSWIG4(Formula.getCPtr(f), f, Variable.getCPtr(v), v), true);
  }
  ...
  public static Formula imply(Formula f1, Formula f2) {
    return new Formula(
        DrealJNI.implySWIG0(Formula.getCPtr(f1), f1, Formula.getCPtr(f2), f2), true);
  }
  ...
  public static Formula iff(Formula f1, Formula f2) {
    return new Formula(
        DrealJNI.iffSWIG0(Formula.getCPtr(f1), f1, Formula.getCPtr(f2), f2), true);
  }
  ...
  public static Formula iff(Variable v1, Variable v2) {
    return new Formula(
        DrealJNI.iffSWIG3(Variable.getCPtr(v1), v1, Variable.getCPtr(v2), v2), true);
  }
  ...
  public static SwigTypePStdOstream insertOperator(
      SwigTypePStdOstream os, RelationalOperator op) {
    return new SwigTypePStdOstream(
        DrealJNI.insertOperatorSWIG6(SwigTypePStdOstream.getCPtr(os), op.swigValue()),
        false);
  }
  ...
  public static SwigTypePStdOstream insertOperator(SwigTypePStdOstream os, Logic logic) {
    return new SwigTypePStdOstream(
        DrealJNI.insertOperatorSWIG7(SwigTypePStdOstream.getCPtr(os), logic.swigValue()),
        false);
  }
  ...
  public static SwigTypePStdOstream DisplayDiff(
      ...
      SwigTypePIbexIntervalVector old_iv,
      SwigTypePIbexIntervalVector new_iv) {
    return new SwigTypePStdOstream(
        DrealJNI.displayDiff(
            SwigTypePStdOstream.getCPtr(os),
            VariableVector.getCPtr(variables),
            variables,
            SwigTypePIbexIntervalVector.getCPtr(old_iv),
            SwigTypePIbexIntervalVector.getCPtr(new_iv)),
        false);
  }

  public static SwigTypePStdOstream insertOperator(
      SwigTypePStdOstream os, Config.SatDefaultPhase sat_default_phase) {
    return new SwigTypePStdOstream(
        DrealJNI.insertOperatorSWIG9(
            SwigTypePStdOstream.getCPtr(os), sat_default_phase.swigValue()),
        false);
  }
  ...
  public static boolean checkSatisfiability(Formula f, double delta, Box box) {
    return DrealJNI.checkSatisfiabilitySWIG0(
