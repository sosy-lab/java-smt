...
// Then, enable model generation.
    bitwuzlaJNI.bitwuzla_set_option(options, SWIG_BitwuzlaOption.BITWUZLA_OPT_PRODUCE_MODELS.swigValue(), 1);
...
// if the selected solver is not compiled in.
    bitwuzlaJNI.bitwuzla_set_option_mode(options, SWIG_BitwuzlaOption.BITWUZLA_OPT_SAT_SOLVER.swigValue(), "cadical");
// Then, create a Bitwuzla instance.
    long bitwuzla = bitwuzlaJNI.bitwuzla_new(options);
...
// (bvsdiv x (_ bv2 8))
    long sdiv = bitwuzlaJNI.bitwuzla_mk_term2(SWIG_BitwuzlaKind.BITWUZLA_KIND_BV_SDIV.swigValue(), x, two);
// (bvashr y (_ bv1 8))
    long ashr = bitwuzlaJNI.bitwuzla_mk_term2(SWIG_BitwuzlaKind.BITWUZLA_KIND_BV_ASHR.swigValue(), y, one);
// ((_ extract 3 0) (bvsdiv x (_ bv2 8)))
    long sdive = bitwuzlaJNI.bitwuzla_mk_term1_indexed2(SWIG_BitwuzlaKind.BITWUZLA_KIND_BV_EXTRACT.swigValue(), sdiv, 3, 0);
// ((_ extract 3 0) (bvashr x (_ bv1 8)))
    long ashre = bitwuzlaJNI.bitwuzla_mk_term1_indexed2(SWIG_BitwuzlaKind.BITWUZLA_KIND_BV_EXTRACT.swigValue(), ashr, 3, 0);

// (assert
//     (distinct
//         ((_ extract 3 0) (bvsdiv x (_ bv2 8)))
//         ((_ extract 3 0) (bvashr y (_ bv1 8)))))
    bitwuzlaJNI.bitwuzla_assert(bitwuzla,
        bitwuzlaJNI.bitwuzla_mk_term2(SWIG_BitwuzlaKind.BITWUZLA_KIND_DISTINCT.swigValue(), sdive, ashre));

// (assert (= (f x ((_ extract 6 3) x)) y))
    bitwuzlaJNI.bitwuzla_assert(bitwuzla,
        bitwuzlaJNI.bitwuzla_mk_term2(SWIG_BitwuzlaKind.BITWUZLA_KIND_EQUAL.swigValue(),
            bitwuzlaJNI.bitwuzla_mk_term3(SWIG_BitwuzlaKind.BITWUZLA_KIND_APPLY.swigValue(),
                f,
                x,
                bitwuzlaJNI.bitwuzla_mk_term1_indexed2(SWIG_BitwuzlaKind.BITWUZLA_KIND_BV_EXTRACT.swigValue(), x, 6, 3)),
            y));

// (assert (= (select a x) y))
    bitwuzlaJNI.bitwuzla_assert(bitwuzla,
        bitwuzlaJNI.bitwuzla_mk_term2(SWIG_BitwuzlaKind.BITWUZLA_KIND_EQUAL.swigValue(),
            bitwuzlaJNI.bitwuzla_mk_term2(SWIG_BitwuzlaKind.BITWUZLA_KIND_ARRAY_SELECT.swigValue(), a, x),
            y));
...
// (check-sat)
    ...
    System.out.println("Bitwuzla: " + (result == BitwuzlaResult.BITWUZLA_SAT.swigValue() ? "sat" : (result == BitwuzlaResult.BITWUZLA_UNSAT.swigValue() ? "unsat" : "unknown")));
    ...
    for (int i = 0; i < 4; ++i) {
      ...
      if (bitwuzlaJNI.bitwuzla_sort_is_fun(sort)) {
        ...
        assert size[0] == 2;
        int j = 0;
        while (bitwuzlaJNI.bitwuzla_term_get_kind(bitwuzlaJNI.BitwuzlaTermArray_getitem(children, 1)) == SWIG_BitwuzlaKind.BITWUZLA_KIND_LAMBDA.swigValue()) {
          assert bitwuzlaJNI.bitwuzla_term_is_var(bitwuzlaJNI.BitwuzlaTermArray_getitem(children, 0));
          System.out.print((j > 0 ? " " : "") +
              bitwuzlaJNI.bitwuzla_term_to_string(bitwuzlaJNI.BitwuzlaTermArray_getitem(children, 0)) + " " +
              bitwuzlaJNI.bitwuzla_sort_to_string(bitwuzlaJNI.bitwuzla_term_get_sort(bitwuzlaJNI.BitwuzlaTermArray_getitem(children, 0))) + " ");
        ...
        System.out.print((j > 0 ? " " : "") +
            bitwuzlaJNI.bitwuzla_term_to_string(bitwuzlaJNI.BitwuzlaTermArray_getitem(children, 0)) + " " +
            bitwuzlaJNI.bitwuzla_sort_to_string(bitwuzlaJNI.bitwuzla_term_get_sort(bitwuzlaJNI.BitwuzlaTermArray_getitem(children, 0))) + ") ");
        System.out.print(bitwuzlaJNI.bitwuzla_sort_to_string(bitwuzlaJNI.bitwuzla_sort_fun_get_codomain(sort)) + " ");
        System.out.println(bitwuzlaJNI.bitwuzla_term_to_string(bitwuzlaJNI.BitwuzlaTermArray_getitem(children, 1)));
      } else {
        System.out.println(") " + bitwuzlaJNI.bitwuzla_sort_to_string(sort) + " " +
    ...
    System.out.println("value of x: " + bitwuzlaJNI.bitwuzla_term_value_get_str(bitwuzlaJNI.bitwuzla_get_value(bitwuzla, x), 2));
    System.out.println("value of y: " + bitwuzlaJNI.bitwuzla_term_value_get_str(bitwuzlaJNI.bitwuzla_get_value(bitwuzla, y), 2));
    System.out.println();
    ...
    System.out.println(bitwuzlaJNI.bitwuzla_term_to_string(bitwuzlaJNI.bitwuzla_get_value(bitwuzla, f)));
    System.out.println("to_string representation of value of a:");
    System.out.println(bitwuzlaJNI.bitwuzla_term_to_string(bitwuzlaJNI.bitwuzla_get_value(bitwuzla, a)));
    System.out.println();
    ...
    System.out.println("to_string representation of value of x: " + bitwuzlaJNI.bitwuzla_term_to_string(bitwuzlaJNI.bitwuzla_get_value(bitwuzla, x)));
    System.out.println("to_string representation of value of y: " + bitwuzlaJNI.bitwuzla_term_to_string(bitwuzlaJNI.bitwuzla_get_value(bitwuzla, y)));
    System.out.println();

    // Query value of bit-vector term that does not occur in the input formula
    long v = bitwuzlaJNI.bitwuzla_get_value(
        bitwuzla,
        bitwuzlaJNI.bitwuzla_mk_term2(SWIG_BitwuzlaKind.BITWUZLA_KIND_BV_MUL.swigValue(), x, x));
    System.out.println("value of v = x * x: " + bitwuzlaJNI.bitwuzla_term_value_get_str(bitwuzlaJNI.bitwuzla_get_value(bitwuzla, v), 2));
