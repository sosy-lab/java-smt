...
class Z3LegacyStringFormulaManager extends AbstractStringFormulaManager<Long, Long, Long, Long> {

  private final long z3context;

  Z3LegacyStringFormulaManager(Z3LegacyFormulaCreator creator) {
    super(creator);
  ...
  protected Long lessThan(Long pParam1, Long pParam2) {
    throw new UnsupportedOperationException("Not supported in legacy z3");
  }
