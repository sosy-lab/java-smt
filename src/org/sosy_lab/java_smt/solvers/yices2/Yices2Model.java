...
public class Yices2Model extends AbstractModel<Integer, Integer, Long> {
  ...
  protected Yices2Model(
      long model, Yices2TheoremProver prover, Yices2FormulaManager pFormulaManager) {
    super(prover, pFormulaManager);
    this.model = model;
    this.prover = prover; // can be NULL for testing
    this.formulaCreator =
        Preconditions.checkNotNull((Yices2FormulaCreator) pFormulaManager.getFormulaCreator());
  }
