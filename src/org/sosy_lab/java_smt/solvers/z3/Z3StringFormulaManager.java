...
class Z3StringFormulaManager extends AbstractStringFormulaManager<Long, Long, Long, Long> {
  ...
  @Override
  protected Long greaterThan(Long pParam1, Long pParam2) { return Native.mkGt(z3context, pParam1, pParam2); }

  @Override
  protected Long greaterOrEquals(Long pParam1, Long pParam2) { return Native.mkGe(z3context, pParam1, pParam2); }

  @Override
  protected Long lessThan(Long pParam1, Long pParam2) { return Native.mkLt(z3context, pParam1, pParam2); }

  @Override
  protected Long lessOrEquals(Long pParam1, Long pParam2) { return Native.mkLe(z3context, pParam1, pParam2); }

  @Override
  protected Long length(Long pParam) { return Native.mkSeqLength(z3context, pParam); }
  ...
  @Override
  protected Long in(Long pParam1, Long pParam2) { return Native.mkSeqInRe(z3context, pParam1, pParam2); }
  ...
  @Override
  protected Long noneImpl() { return Native.mkReEmpty(z3context, formulaCreator.getStringType()); }

  @Override
  protected Long allImpl() { return Native.mkReFull(z3context, formulaCreator.getStringType()); }

  @Override
  protected Long allCharsImpl() { return makeRegexImpl("."); }
