...
public class Z3ToResolutionProofConverter { // This class is incomplete and currently not used. The
  ...
  //          T2: (~ p q)
  //          [mp~ T1 T2]: q
  // Strategy: Introduce (not (T1 and T2)) or q as an axiom and proceed to resolve T1 and T2 to
  // end up with q.
