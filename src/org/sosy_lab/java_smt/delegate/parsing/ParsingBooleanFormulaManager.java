...
class ParsingBooleanFormulaManager implements BooleanFormulaManager {
  private final BooleanFormulaManager delegate;
  private final ParsingFormulaManager.Declarations declarations;

  ParsingBooleanFormulaManager(
      BooleanFormulaManager pDelegate, ParsingFormulaManager.Declarations pDeclarations) {
    delegate = pDelegate;
  ...
  public BooleanFormula makeVariable(String pVar) {
    BooleanFormula term = delegate.makeVariable(pVar);
