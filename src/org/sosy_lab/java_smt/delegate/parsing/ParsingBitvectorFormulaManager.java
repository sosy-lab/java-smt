...
public class ParsingBitvectorFormulaManager implements BitvectorFormulaManager {
  ...
  public ParsingBitvectorFormulaManager(
      BitvectorFormulaManager pDelegate, ParsingFormulaManager.Declarations pDeclarations) {
    delegate = pDelegate;
  ...
  public BitvectorFormula makeVariable(int length, String pVar) {
    BitvectorFormula term = delegate.makeVariable(length, pVar);
  ...
  public BitvectorFormula makeVariable(FormulaType.BitvectorType type, String pVar) {
    BitvectorFormula term = delegate.makeVariable(type, pVar);
    declarations.addConstant(pVar, term);
    return term;
  }
