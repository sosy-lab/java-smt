...
public class ParsingArrayFormulaManager implements ArrayFormulaManager {
  ...
  public ParsingArrayFormulaManager(
      ArrayFormulaManager pDelegate, ParsingFormulaManager.Declarations pDeclarations) {
    delegate = pDelegate;
  ...
  public <
    ...
    ArrayFormula<TI, TE> term = delegate.makeArray(pName, pIndexType, pElementType);
    declarations.addConstant(pName, term);
    return term;
  }
