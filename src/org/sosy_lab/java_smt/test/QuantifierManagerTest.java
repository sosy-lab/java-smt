...
public class QuantifierManagerTest extends SolverBasedTest0.ParameterizedSolverBasedTest0 {
  ...
  public void testEmptyIllegalArgumentException() {
    assume()
        .withMessage("Solver throws NullPointerException instead.")
        .that(solverToUse())
        .isNoneOf(Solvers.OPENSMT, Solvers.MATHSAT5, Solvers.SMTINTERPOL, Solvers.YICES2);
    assume()
  ...
  public void testEmptyNullPointerException() {
    assume()
        .withMessage("Solver throws IllegalArgumentException instead.")
        .that(solverToUse())
        .isNoneOf(Solvers.Z3, Solvers.CVC4, Solvers.CVC5, Solvers.BOOLECTOR);
    assume()
        .withMessage("TODO: The JavaSMT code for Princess explicitly allows this.")
        .that(solverToUse())
        .isNotEqualTo(Solvers.PRINCESS);
