...
public class SolverStackTest extends SolverBasedTest.ParameterizedSolverBasedTest {

  /**
   * Returns a {@link org.sosy_lab.java_smt.api.ProverEnvironment ProverEnvironment} for the tests.
   *
   * <p>Override to get a {@link org.sosy_lab.java_smt.api.OptimizationProverEnvironment
   * OptimizationProverEnvironment} or {@link
   * org.sosy_lab.java_smt.api.InterpolatingProverEnvironment InterpolationProverEnvironment}
   * instead
   */
  ...
  /**
   * Checks if the solver supports theory combinations.
   *
   * <p>Override if one of the solver doesn't support theory combinations for interpolation or
   * optimization
   */
