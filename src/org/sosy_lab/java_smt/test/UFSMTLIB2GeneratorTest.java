...
public class UFSMTLIB2GeneratorTest extends SolverBasedTest0.ParameterizedSolverBasedTest0 {
  ...
  public void testdeclareUFBoolean() {
    ...
    FunctionDeclaration<BooleanFormula>
        a = fmgr.declareUF("a", FormulaType.BooleanType, FormulaType.BooleanType);
  ...
  public void testDeclareUFInteger() {
    ...
    FunctionDeclaration<IntegerFormula>
        a = fmgr.declareUF("a", FormulaType.IntegerType, FormulaType.IntegerType);
  ...
  public void testDeclareUFRational() {
    requireRationals();
    clearGenerator();
    FunctionDeclaration<RationalFormula>
        a = fmgr.declareUF("a", FormulaType.RationalType, FormulaType.RationalType);
  ...
  public void testDeclareUFBitvectors() {
    requireBitvectors();
    clearGenerator();
    FunctionDeclaration<BitvectorFormula>
        a = fmgr.declareUF("a", FormulaType.getBitvectorTypeWithSize(4), FormulaType.getBitvectorTypeWithSize(4));
    FunctionDeclaration<BitvectorFormula> b = fmgr.declareUF("b", FormulaType.getBitvectorTypeWithSize(4),
        new ArrayList<>());
  ...
  public void testDeclareUFArrays() {
    ...
    requireIntegers();
    clearGenerator();
    FunctionDeclaration<ArrayFormula<IntegerFormula, IntegerFormula>>
        a = fmgr.declareUF("a", FormulaType.getArrayType(FormulaType.IntegerType, FormulaType.IntegerType),
        FormulaType.getArrayType(FormulaType.getArrayType(FormulaType.IntegerType,
            FormulaType.IntegerType), FormulaType.IntegerType));
    FunctionDeclaration<ArrayFormula<IntegerFormula, IntegerFormula>> b = fmgr.declareUF("b",
        FormulaType.getArrayType(FormulaType.IntegerType, FormulaType.IntegerType),
        new ArrayList<>());
    FunctionDeclaration<BooleanFormula> constr = fmgr.declareUF("constr", FormulaType.BooleanType
        , FormulaType.getArrayType(FormulaType.IntegerType,
            FormulaType.IntegerType), FormulaType.getArrayType(FormulaType.IntegerType,
            FormulaType.IntegerType));

    ArrayFormula<IntegerFormula, IntegerFormula> c = fmgr.callUF(a, Objects.requireNonNull(amgr)
