      ...
      case PRINCESS:
        expected =
            "digraph SMT {\n"
                ...
                + " fillcolor=\"white\"];\n"
                + "  1 -> 9 [label=\"0\"];\n"
                + "  9 [label=\"+\", shape=\"circle\", style=\"filled\", fillcolor=\"white\"];\n"
                + "  9 -> 10 [label=\"0\"];\n"
                + "  9 -> 11 [label=\"1\"];\n"
                + "  11 [label=\"*\", shape=\"circle\", style=\"filled\", fillcolor=\"white\"];\n"
                + "  11 -> 5 [label=\"0\"];\n"
                + "  11 -> 12 [label=\"1\"];\n"
                + "  12 [label=\"foo\", shape=\"circle\", style=\"filled\", fillcolor=\"white\"];\n"
                + "  12 -> 13 [label=\"0\"];\n"
                + "  13 [label=\"3\", shape=\"rectangle\", style=\"filled\", fillcolor=\"grey\"];\n"
