...
public class SolverFormulaIOTest extends SolverBasedTest0.ParameterizedSolverBasedTest0 {
  ...
  @Test
  public void parseMathSatTestExprFirst1()
      throws SolverException, InterruptedException, IOException {
    requireParser();
  ...
  @Test
  public void parseMathSatTestExprFirst2()
      throws SolverException, InterruptedException, IOException {
    requireParser();
  ...
  @Test
  public void parseZ3SatTestParseFirst2()
      throws SolverException, InterruptedException, IOException {
    requireParser();
  ...
  @Test
  public void parseMathSatTestExprFirst3()
      throws SolverException, InterruptedException, IOException {
    requireParser();
