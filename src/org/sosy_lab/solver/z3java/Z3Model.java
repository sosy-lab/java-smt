...
import static org.sosy_lab.solver.z3java.Z3NativeApi.mk_app;
import static org.sosy_lab.solver.z3java.Z3NativeApi.model_eval;
import static org.sosy_lab.solver.z3java.Z3NativeApi.model_get_const_decl;
import static org.sosy_lab.solver.z3java.Z3NativeApi.model_get_const_interp;
import static org.sosy_lab.solver.z3java.Z3NativeApi.model_get_num_consts;
import static org.sosy_lab.solver.z3java.Z3NativeApi.model_inc_ref;
import static org.sosy_lab.solver.z3java.Z3NativeApi.model_to_string;
...
import org.sosy_lab.solver.z3java.Z3NativeApi.PointerToLong;
...
class Z3Model extends AbstractModel<Long, Long, Long> {
  ...
  Z3Model(Context pZ3context, com.microsoft.z3.Model pModel, Z3FormulaCreator pCreator) {
    super(pCreator);
    model_inc_ref(pZ3context, pModel);
    model = pModel;
