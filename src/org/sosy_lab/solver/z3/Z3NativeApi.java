...
public final class Z3NativeApi {
   ...
   */
  public static native void optimize_assert(long context, long optimize, long ast);
  ...
  public static native boolean get_param_value(
      long context, String param_id, PointerToString param_value);
  ...
  public static native void params_set_symbol(
      long context, long params, long symbol, long symbol_value);
  ...
  public static native long mk_tuple_sort(
      long context,
      long symbol,
      int len,
      long[] symbols,
  ...
  public static native long mk_enumeration_sort(
      long context, long symbol, int len, long[] symbols, long[] enum_consts, long[] enum_testers);

  public static native long mk_list_sort(
      long context,
      long symbol,
      long sort,
  ...
  public static native long mk_constructor(
      long context,
      long symbol,
      long recognizer,
      int len,
  ...
  public static native void mk_datatypes(
      long context, int len, long[] symbols, long[] sorts, long[] constructor_lists);

  public static native void query_constructor(
      long context,
      long constructor,
      int len,
  ...
  public static native long mk_fresh_func_decl(
  ...
  public static native long mk_bvsub_no_underflow(
      long context, long a1, long a2, boolean is_signed);
  ...
  public static native long mk_forall(
      long context, int a1, int a2, long[] a3, int a4, long[] a5, long[] a6, long a7);

  public static native long mk_exists(
      long context, int a1, int a2, long[] a3, int a4, long[] a5, long[] a6, long a7);

  public static native long mk_quantifier(
      long context, boolean a1, int a2, int a3, long[] a4, int a5, long[] a6, long[] a7, long a8);

  public static native long mk_quantifier_ex(
      long context,
      boolean a1,
      int a2,
      long a3,
  ...
  public static native long mk_forall_const(
      long context, int a1, int a2, long[] a3, int a4, long[] a5, long a6);

  public static native long mk_exists_const(
      long context, int a1, int a2, long[] a3, int a4, long[] a5, long a6);

  public static native long mk_quantifier_const(
      long context, boolean a1, int a2, int a3, long[] a4, int a5, long[] a6, long a7);

  public static native long mk_quantifier_const_ex(
      long context,
      boolean a1,
      int a2,
      long a3,
  ...
  public static native long get_datatype_sort_constructor_accessor(
      long context, long a1, int a2, int a3);
  ...
  public static native boolean get_numeral_small(
  ...
  public static native boolean get_numeral_rational_int64(
      long context, long a1, PointerToLong a2, PointerToLong a3);
   ...
   */
  public static native long substitute(long context, long a, int num_exprs, long[] from, long[] to);
   ...
   * @return Formula with substitutions applied.
   */
  public static native long substitute_vars(long context, long a, int num_exprs, long[] to);

  public static native long translate(long contextSource, long a, long contextTarget);
   ...
   */
  public static native boolean model_eval(
  ...
  public static native String benchmark_to_smtlib_string(
      long context,
      String name,
      String logic,
      String status,
  ...
  public static long parse_smtlib2_string(
      long context,
      String str,
      long[] sort_symbols,
      long[] sorts,
  ...
  public static long parse_smtlib2_file(
      long context,
      String filename,
      long[] sort_symbols,
      long[] sorts,
  ...
  public static void parse_smtlib_string(
      long context,
      String str,
      long[] sort_symbols,
      long[] sorts,
  ...
  public static void parse_smtlib_file(
      long context,
      String filename,
      long[] sort_symbols,
      long[] sorts,
  ...
  // MISC
  public static native void get_version(
  ...
  public static native void fixedpoint_set_predicate_representation(
  ...
  public static native long ast_vector_translate(
  ...
  public static native void ast_map_insert(
      long context, long ast_map, long ast_key, long ast_value);
   ...
   */
  public static native long mk_goal(
      long context, boolean models, boolean unsat_cores, boolean proofs);
   ...
   * @return Z3_model
   */
  public static native long apply_result_convert_model(
      long context, long apply_result, int i, long model);
  ...
  public static native int solver_check_assumptions(
