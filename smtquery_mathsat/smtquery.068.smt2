...
(define-fun .413 () Bool (bvslt .154 .10))
(define-fun .433 () Bool (and .366 .413))
(define-fun .434 () Bool (and .131 .433))
(define-fun .435 () Bool (and .240 .434))
(define-fun .436 () Bool (and .23 .435))
(assert .436)
(check-sat)
(push 1)
