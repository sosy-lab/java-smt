...
(define-fun .441 () Bool (and .92 .428))
(define-fun .458 () Bool (and .413 .441))
(define-fun .459 () Bool (and .131 .458))
(define-fun .460 () Bool (and .240 .459))
(define-fun .461 () Bool (and .23 .460))
(assert .461)
(check-sat)
