...
(define-fun .195 () Bool (and .92 .162))
(define-fun .196 () Bool (and .159 .195))
(define-fun .198 () Bool (and .121 .128))
(define-fun .231 () Bool (and .158 .196))
(define-fun .232 () Bool (and .23 .231))
(define-fun .233 () Bool (and .198 .232))
(assert .233)
(check-sat)
