...
(define-fun .415 () Bool (and .342 .413))
(define-fun .416 () Bool (and .131 .415))
(define-fun .417 () Bool (and .101 .416))
(define-fun .418 () Bool (and .240 .417))
(define-fun .419 () Bool (and .23 .418))
(assert .419)
(check-sat)
(push 1)
