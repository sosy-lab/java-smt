...
(define-fun .348 () Bool (not .337))
(define-fun .392 () Bool (and .340 .348))
(define-fun .393 () Bool (and .52 .392))
(define-fun .394 () Bool (and .62 .393))
(define-fun .395 () Bool (and .131 .394))
(define-fun .396 () Bool (and .101 .395))
(define-fun .397 () Bool (and .240 .396))
(define-fun .398 () Bool (and .23 .397))
(assert .398)
(check-sat)
