...
(define-fun .123 () Bool (and .89 .121))
(define-fun .124 () Bool (and .52 .123))
(define-fun .140 () Bool (and .92 .124))
(define-fun .141 () Bool (and .62 .140))
(define-fun .142 () Bool (and .23 .141))
(assert .142)
(check-sat)
(push 1)
...
(define-fun .132 () Bool (or .18 .131))
(assert .132)
(check-sat-assuming (.9 ))
(pop 1)
(push 1)
(define-fun .128 () Bool (= .55 .10))
(define-fun .129 () Bool (not .128))
(define-fun .147 () Bool (or .18 .129))
(assert .147)
(check-sat-assuming (.9 ))
(pop 1)
