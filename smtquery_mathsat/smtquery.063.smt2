...
(define-fun .305 () Bool (and .92 .281))
(define-fun .306 () Bool (and .131 .305))
(define-fun .357 () Bool (and .159 .306))
(define-fun .360 () Bool (and .25 .64))
(define-fun .399 () Bool (and .158 .357))
(define-fun .400 () Bool (and .240 .399))
(define-fun .401 () Bool (and .23 .400))
(define-fun .402 () Bool (and .360 .401))
(assert .402)
(check-sat)
