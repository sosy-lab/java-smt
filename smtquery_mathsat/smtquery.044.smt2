...
(define-fun .204 () Bool (and .92 .183))
(define-fun .205 () Bool (and .62 .204))
(define-fun .206 () Bool (and .131 .205))
(define-fun .240 () Bool (bvslt .8 .119))
(define-fun .254 () Bool (and .206 .240))
(define-fun .255 () Bool (and .23 .254))
(assert .255)
(check-sat)
(push 1)
