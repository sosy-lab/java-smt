...
(define-fun .245 () Bool (not .240))
(define-fun .247 () Bool (and .180 .245))
(define-fun .248 () Bool (and .89 .247))
(define-fun .249 () Bool (and .52 .248))
(define-fun .250 () Bool (and .62 .249))
(define-fun .251 () Bool (and .131 .250))
(define-fun .252 () Bool (and .101 .251))
(define-fun .270 () Bool (and .240 .252))
(define-fun .271 () Bool (and .23 .270))
(assert .271)
(check-sat)
