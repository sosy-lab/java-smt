...
(define-fun .189 () Bool (not .180))
(define-fun .227 () Bool (and .184 .189))
(define-fun .228 () Bool (and .131 .227))
(define-fun .229 () Bool (and .101 .228))
(define-fun .230 () Bool (and .23 .229))
(assert .230)
(check-sat)
