...
(define-fun .259 () Bool (and .92 .249))
(define-fun .260 () Bool (and .62 .259))
(define-fun .261 () Bool (and .131 .260))
(define-fun .272 () Bool (and .240 .261))
(define-fun .273 () Bool (and .23 .272))
(assert .273)
(check-sat)
