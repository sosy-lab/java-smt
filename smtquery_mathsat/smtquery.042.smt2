...
(define-fun .182 () Bool (and .89 .180))
(define-fun .183 () Bool (and .52 .182))
(define-fun .184 () Bool (and .62 .183))
(define-fun .185 () Bool (and .131 .184))
(define-fun .186 () Bool (and .101 .185))
(define-fun .240 () Bool (bvslt .8 .119))
(define-fun .242 () Bool (and .186 .240))
(define-fun .243 () Bool (and .23 .242))
(assert .243)
(check-sat)
(push 1)
