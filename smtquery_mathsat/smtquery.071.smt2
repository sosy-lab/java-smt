...
(define-fun .421 () Bool (not .413))
(define-fun .423 () Bool (and .65 .421))
(define-fun .424 () Bool (and .180 .423))
(define-fun .425 () Bool (and .337 .424))
(define-fun .426 () Bool (and .89 .425))
(define-fun .427 () Bool (and .52 .426))
(define-fun .428 () Bool (and .62 .427))
(define-fun .453 () Bool (and .413 .428))
(define-fun .454 () Bool (and .131 .453))
(define-fun .455 () Bool (and .101 .454))
(define-fun .456 () Bool (and .240 .455))
(define-fun .457 () Bool (and .23 .456))
(assert .457)
(check-sat)
