...
(define-fun .350 () Bool (and .298 .348))
(define-fun .351 () Bool (and .52 .350))
(define-fun .352 () Bool (and .62 .351))
(define-fun .353 () Bool (and .131 .352))
(define-fun .354 () Bool (and .101 .353))
(define-fun .355 () Bool (and .240 .354))
(define-fun .356 () Bool (and .23 .355))
(assert .356)
(check-sat)
