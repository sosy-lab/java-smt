...
public final class Option {
  ...
  public final static Option PRODUCE_INTERPOLANTS = new Option("PRODUCE_INTERPOLANTS");
  ...
  public final static Option WRITE_AIGER = new Option("WRITE_AIGER");
  public final static Option WRITE_CNF = new Option("WRITE_CNF");
  ...
  public final static Option INTERPOLANTS_ALGO = new Option("INTERPOLANTS_ALGO");
  public final static Option INTERPOLANTS_LIFT = new Option("INTERPOLANTS_LIFT");
  public final static Option INTERPOLANTS_SUBST = new Option("INTERPOLANTS_SUBST");
  public final static Option INTERPOLANTS_SIMP = new Option("INTERPOLANTS_SIMP");
  public final static Option INTERPOLANTS_STATS = new Option("INTERPOLANTS_STATS");
  public final static Option INTERPOLANTS_PRINT_STATS = new Option("INTERPOLANTS_PRINT_STATS");
  ...
  public final static Option DBG_CHECK_INTERPOLANT = new Option("DBG_CHECK_INTERPOLANT");
  ...
  private static Option[] swigValues = { LOGLEVEL, PRODUCE_MODELS, PRODUCE_INTERPOLANTS, PRODUCE_UNSAT_ASSUMPTIONS, PRODUCE_UNSAT_CORES, SEED, VERBOSITY, TIME_LIMIT_PER, MEMORY_LIMIT, NTHREADS, BV_SOLVER, REWRITE_LEVEL, SAT_SOLVER, WRITE_AIGER, WRITE_CNF, PROP_CONST_BITS, PROP_INFER_INEQ_BOUNDS, PROP_NPROPS, PROP_NUPDATES, PROP_OPT_LT_CONCAT_SEXT, PROP_PATH_SEL, PROP_PROB_RANDOM_INPUT, PROP_PROB_USE_INV_VALUE, PROP_SEXT, ABSTRACTION, ABSTRACTION_BV_SIZE, ABSTRACTION_EAGER_REFINE, ABSTRACTION_VALUE_LIMIT, ABSTRACTION_VALUE_ONLY, ABSTRACTION_ASSERT, ABSTRACTION_ASSERT_REFS, ABSTRACTION_INITIAL_LEMMAS, ABSTRACTION_INC_BITBLAST, ABSTRACTION_BV_ADD, ABSTRACTION_BV_MUL, ABSTRACTION_BV_UDIV, ABSTRACTION_BV_UREM, ABSTRACTION_ITE, INTERPOLANTS_ALGO, INTERPOLANTS_LIFT, INTERPOLANTS_SUBST, INTERPOLANTS_SIMP, INTERPOLANTS_STATS, INTERPOLANTS_PRINT_STATS, PREPROCESS, PP_CONTRADICTING_ANDS, PP_ELIM_BV_EXTRACTS, PP_ELIM_BV_UDIV, PP_EMBEDDED_CONSTR, PP_FLATTEN_AND, PP_NORMALIZE, PP_SKELETON_PREPROC, PP_VARIABLE_SUBST, PP_VARIABLE_SUBST_NORM_EQ, PP_VARIABLE_SUBST_NORM_DISEQ, PP_VARIABLE_SUBST_NORM_BV_INEQ, DBG_RW_NODE_THRESH, DBG_PP_NODE_THRESH, DBG_CHECK_INTERPOLANT, DBG_CHECK_MODEL, DBG_CHECK_UNSAT_CORE, NUM_OPTS };
