...
(assert (and ((_ is list) x1) ((_ is cons) (lv x1))))
(assert (and ((_ is list) x1) ((_ is cons) (lv x1)) (= x2 (th (lv x1)))))
(assert (and ((_ is list) x1) ((_ is cons) (lv x1)) (= x3 (list (tail (lv x1))))))
(assert (not (= (int 42) x2)))
(assert (and ((_ is list) (list nil)) (= x4 (list (cons x2 (lv (list nil)))))))
