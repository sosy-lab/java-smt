...
public class Logic {
  ...
  public String sortToString(SRef s) {
    return OsmtNativeJNI.Logic_sortToString(swigCPtr, this, SRef.getCPtr(s), s);
  }
  ...
  public boolean isBoolVar(PTRef tr) {
    return OsmtNativeJNI.Logic_isBoolVar(swigCPtr, this, PTRef.getCPtr(tr), tr);
  }

  public boolean isLiteral(PTRef tr) {
    return OsmtNativeJNI.Logic_isLiteral(swigCPtr, this, PTRef.getCPtr(tr), tr);
  }
  ...
  public String termToSMT2String(PTRef tr) {
    return OsmtNativeJNI.Logic_termToSMT2String__SWIG_0(swigCPtr, this, PTRef.getCPtr(tr), tr);
  }

  public String termToSMT2String(PTRef tr, boolean withRefs) {
    return OsmtNativeJNI.Logic_termToSMT2String__SWIG_1(swigCPtr, this, PTRef.getCPtr(tr), tr, withRefs);
  }
  ...
  public String symToString(SymRef sr) {
    return OsmtNativeJNI.Logic_symToString(swigCPtr, this, SymRef.getCPtr(sr), sr);
  }
